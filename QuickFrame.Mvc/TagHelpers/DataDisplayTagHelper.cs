...
namespace QuickFrame.Mvc.TagHelpers {
	...
	/// <summary>
	/// Takes the name specified in the display-for attribute and displays the property associated
	/// with the name.
	/// </summary>
	...
	public class DataDisplayTagHelper : TagHelperBase {
		...
		/// <summary>
		/// Synchronously executes the <see
		/// cref="T:Microsoft.AspNetCore.Razor.TagHelpers.TagHelper"/> with the given <paramref
